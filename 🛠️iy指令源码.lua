...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "Commandbar"
...
ColorsButton = makeSettingsButton("编辑主题","rbxassetid://4911962991")
ColorsButton.Position = UDim2.new(0,5,0,55)
ColorsButton.Size = UDim2.new(1,-10,0,25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("编辑绑定按键","rbxassetid://129697930")
...
Positions = makeSettingsButton("编辑/前往 路径点","rbxassetid://5147488592")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("编辑事件绑定","rbxassetid://5147695474",759)
...
Directions.Text = "单击下面的按钮并按下一键/鼠标按钮。然后选择要绑定到的对象。"
...
ClickTP.Name = "Click TP (Hold Key p& Click)"
...
PositionsHint.Text = "使用'swp'或'setwaypoint'命令使用你的角色添加一个位置(注意:部分传送不会保存)"
...
Directions_3.Text = '点击一个部件，然后点击下面的“选择部件”按钮，将其设置为传送位置'
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / 支持 / 帮助', DESC = '复制Infinite Yield支持服务器邀请'}
CMDs[#CMDs + 1] = {NAME = '控制台', DESC = '加载旧的Roblox控制台'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = '打开DEX by Moon'}
CMDs[#CMDs + 1] = {NAME = '旧dex / odex', DESC = '打开Old DEX by Moon'}
CMDs[#CMDs + 1] = {NAME = 'remote / rspy', DESC = 'Opens FrostHook Spy'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = 'Opens Edges audio logger'}
CMDs[#CMDs + 1] = {NAME = '服务器信息 / info', DESC = '告诉你关于服务器的信息'}
...
CMDs[#CMDs + 1] = {NAME = '重进 / rj', DESC = '让你重新进入游戏'}
CMDs[#CMDs + 1] = {NAME = '自动重进 / autorj', DESC = '当你被踢出游戏或断开连接时自动重进服务器'}
CMDs[#CMDs + 1] = {NAME = '换服 / shop', DESC = '传送你到一个不同的服务器'}
CMDs[#CMDs + 1] = {NAME = '加入玩家 [用户名 / ID] [place ID]', DESC = '加入一个特定的玩家服务器'}
CMDs[#CMDs + 1] = {NAME = 'gameteleport / gametp [place ID]', DESC = 'Joins a game by ID'}
CMDs[#CMDs + 1] = {NAME = '反挂机 / antiafk', DESC = '当你挂机时不会被服务器踢出'}
...
CMDs[#CMDs + 1] = {NAME = '关闭碰撞', DESC = 'Go through objects'}
CMDs[#CMDs + 1] = {NAME = '开启碰撞 / clip', DESC = 'Disables noclip'}
CMDs[#CMDs + 1] = {NAME = '飞行 [速度]', DESC = 'Makes you fly'}
CMDs[#CMDs + 1] = {NAME = '停止飞行', DESC = 'Disables fly'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = '观察 / view [玩家]', DESC = 'View a player'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [part name]', DESC = 'View a part'}
CMDs[#CMDs + 1] = {NAME = '停止观察 / unview', DESC = 'Stops viewing player'}
...
CMDs[#CMDs + 1] = {NAME = 'fixcam / 重置视角', DESC = 'Fixes camera'}
...
CMDs[#CMDs + 1] = {NAME = '甩飞', DESC = '甩飞你碰到的任何物体'}
CMDs[#CMDs + 1] = {NAME = '停止甩飞', DESC = '停止甩飞指令'}
...
addcmd('discord', {'支持', '帮助'}, function(args, speaker)
	if toClipboard then
		toClipboard('https://discord.com/invite/dYHag43eeU')
		notify('Discord 服务器', '已经复制到你的剪贴板!\ndiscord.gg/dYHag43eeU')
	else
...
addcmd('服务器信恄息',{'info','sinfo'},function(args, speaker)
...
addcmd('重进',{'rj'},function(args, speaker)
...
addcmd('自动重进',{'autorj'},function(args, speaker)
...
addcmd('换服',{'shop'},function(args, speaker)
...
addcmd('加入玩家',{'joinp'},function(args, speaker)
	local retries = 0
...
addcmd('关闭碰撞',{},function(args, speaker)
	Clip = false
	wait(0.1)
...
addcmd('clip',{'开启碰撞'},function(args, speaker)
	if Noclipping then
...
addcmd('飞行',{},function(args, speaker)
	NOFLY()
	wait()
	sFLY()
...
addcmd('停止飞行',{'nofly','novfly','unvehiclefly','novehiclefly','unvfly'},function(args, speaker)
	NOFLY()
end)
...
viewing = nil
addcmd('view',{'观察'},function(args, speaker)
	StopFreecam()
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		if viewDied then
...
addcmd('unview',{'停止观察'},function(args, speaker)
	StopFreecam()
	if viewing ~= nil then
		viewing = nil
...
addcmd('fixcam',{'重置视角'},function(args, speaker)
	StopFreecam()
	execCmd('unview')
...
addcmd('antiafk',{'反挂机'},function(args, speaker)
...
addcmd('控制台',{},function(args, speaker)
	-- Thanks wally!!
	notify("Loading",'Hold on a sec')
...
addcmd('旧dex', {'odex'}, function(args, speaker)
...
flinging = false
addcmd('甩飞',{},function(args, speaker)
	flinging = false
	for _, child in pairs(speaker.Character:GetDescendants()) do
...
addcmd('停止甩飞',{'nofling'},function(args, speaker)
	execCmd('clip')
	if flingDied then
...
-- Events
eventEditor.RegisterEvent("注入时")
eventEditor.RegisterEvent("生成时",{
	{Type="Player",Name="Player Filter ($1)"}
})
eventEditor.RegisterEvent("死亡时",{
	{Type="Player",Name="Player Filter ($1)"}
})
eventEditor.RegisterEvent("受伤时",{
	{Type="Player",Name="Player Filter ($1)"},
	{Type="Number",Name="Below Health ($2)"}
})
eventEditor.RegisterEvent("被杀死时",{
	{Type="Player",Name="Victim Player ($1)"},
	{Type="Player",Name="Killer Player ($2)",Default = 1}
})
eventEditor.RegisterEvent("加入时",{
	{Type="Player",Name="Player Filter ($1)",Default = 1}
})
eventEditor.RegisterEvent("说话时",{
	{Type="Player",Name="Player Filter ($1)",Default = 1},
