...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / 支持 / 帮助', DESC = '邀请到Infinite Yield支持服务器'}
...
CMDs[#CMDs + 1] = {NAME = '无碰撞', DESC = 'Go through objects'}
CMDs[#CMDs + 1] = {NAME = '碰撞 / clip', DESC = 'Disables noclip'}
...
CMDs[#CMDs + 1] = {NAME = '甩飞', DESC = '甩飞你碰到的任何人'}
...
addcmd('服务器信息',{'info','sinfo'},function(args, speaker)
...
addcmd('无碰撞',{},function(args, speaker)
	Clip = false
	wait(0.1)
...
addcmd('clip',{'碰撞'},function(args, speaker)
	if Noclipping then
