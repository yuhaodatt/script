if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Mid Hub|Tong#9966汉化",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RenUi:AddTab("自动菜单","")
    local Combat = RenUi:AddTab("战斗","")
    local Stats = RenUi:AddTab("数据点","")
    local Teleport = RenUi:AddTab("传送","")
    local Dungeon = RenUi:AddTab("副本","")
    local DevilFruit = RenUi:AddTab("恶魔果实","")
    local Shop = RenUi:AddTab("商店","")
    local Misc = RenUi:AddTab("其他","")
    --------------------------------------------------------------------
    Main:AddSeperator("设置")
    ...
    function UpdateTime()
        ...
        Time:Set("小时(s) : "..Hour.." 分钟(s) : "..Minute.." 秒(s) : "..Second)
    end
    ...
    Main:AddToggle("自动设置重生点",true,function(value)
    ...
    Main:AddToggle("聚集目标",true,function(value)
    ...
    local SelectWeapona = Main:AddDropdown("选择武器",WeaponList,function(value)
    ...
    Main:AddSeperator("主要")
    
    local AutoFarm = Main:AddToggle("自动等级",_G.AutoFarm,function(value)
        _G.AutoFarm = value
    ...
    if World1 then
        Main:AddToggle("自动二海",_G.AutoSecondSea,function(value)
    ...
    if World2 then
        Main:AddToggle("自动三海",_G.AutoThirdSea,function(value)
    ...
    if World2 then
        Main:AddToggle("自动工厂",_G.AutoFactory,function(value)
    ...
    elseif World3 then
        Main:AddToggle("自动神秘岛",_G.AutoMysticIsland,function(value)
    ...
    Main:AddSeperator("战斗风格")
    
    Main:AddToggle("自动超人拳",_G.AutoSuperhuman,function(value)
    ...
    Main:AddToggle("自动死腿",_G.AutoDeathStep,function(value)
    ...
    Main:AddToggle("自动鲨鱼拳",_G.AutoSharkman,function(value)
    ...
    Main:AddToggle("自动雷爪",_G.AutoElectricClaw,function(value)
    ...
    Main:AddToggle("自动龙爪",_G.AutoDragonTalon,function(value)
    ...
    Main:AddSeperator("精通")
    
    Main:AddToggle("自动水果精通",_G.AutoFarmFruitMastery,function(value)
    ...
    Main:AddToggle("自动枪精通",_G.AutoFarmGunMastery,function(value)
    ...
    _G.Kill_At = 25
    Main:AddSlider("杀死在 %",1,100,25,function(value)
        _G.Kill_At = value
    end)
    ...
    local BossName = Main:AddDropdown("选择boss",Boss,function(value)
        _G.SelectBoss = value
    end)
    
    Main:AddButton("刷新boss",function()
        BossName:Clear()
            for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
            if string.find(v.Name, "Boss") then
                BossName:Add(v.Name) 
    ...
    Main:AddToggle("自动boss",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("自动所有boss",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("自动所有boss Hop",_G.AutoAllBossHop,function(value)
    ...
    Main:AddToggle("自动面团boss",_G.AutoDoughtBoss,function(value)
    ...
    Main:AddSeperator("觉醒副本")
    
    Main:AddToggle("自动觉醒副本",_G.AutoAdvanceDungeon,function(value)
    ...
    Main:AddSeperator("budy刀")
    
    Main:AddToggle("自动budy刀",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:AddToggle("自动budy刀 Hop",_G.AutoBudySwordHop,function(value)
    ...
    Main:AddToggle("自动精英猎人",_G.AutoElitehunter,function(value)
    ...
    Main:AddToggle("自动精英猎人 Hop",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    Main:AddSeperator("神圣镰刀")
    
    Main:AddToggle("自动神圣镰刀",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    Main:AddToggle("自动神圣镰刀 Hop",_G.AutoFarmBossHallowHop,function(value)
    ...
    Main:AddSeperator("黑暗匕首")
    
    Main:AddToggle("自动黑暗匕首",_G.AutoDarkDagger,function(value)
    ...
    Main:AddToggle("自动黑暗匕首 Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    Main:AddSeperator("天鹅眼镜")
    
    Main:AddToggle("自动天鹅眼镜",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:AddToggle("自动天鹅眼镜 Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    local BoneFarm = Main:AddToggle("自动骨头",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main:AddToggle("自动观察",_G.AutoObservation,function(value)
    ...
    Main:AddToggle("自动观察 Hop",_G.AutoObservation_Hop,function(value)
    ...
    Main:AddSeperator("红发刀")
    
    Main:AddToggle("自动红发刀",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    Main:AddToggle("自动红发刀 Hop",_G.AutoSaber_Hop,function(value)
    ...
    Main:AddSeperator("传奇剑")
    
    Main:AddToggle("自动买传奇剑",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:AddToggle("自动买传奇剑 Hop",_G.AutoBuyLegendarySword_Hop,function(value)
        _G.AutoBuyLegendarySword_Hop = value
    end)
    
    Main:AddSeperator("武装色")
    
    Main:AddToggle("自动买武装色",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    Main:AddToggle("自动买武装色 Hop",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    Main:AddSeperator("其他")
    
    Main:AddToggle("自动买火枪手帽子",_G.AutoMusketeerHat,function(value)
    ...
    Main:AddToggle("自动彩色武装色",_G.Auto_Rainbow_Haki,function(value)
    ...
    Main:AddToggle("自动观察v2",_G.AutoObservationv2,function(value)
    ...
    Main:AddToggle("自动神秘物质",_G.AutoEctoplasm,function(value)
    ...
    Main:AddToggle("自动yama剑",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    Main:AddToggle("自动升级种族",_G.Auto_EvoRace,function(value)
    ...
    Main:AddToggle("自动Bartlio任务",_G.AutoBartilo,function(value)
    ...
    Main:AddToggle("自动点燃神圣火把",_G.AutoHolyTorch,function(value)
    ...
    local plyserv = Combat:AddLabel("玩家功能")
    ...
    Combat:AddButton("刷新玩家",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    Combat:AddToggle("观察玩家",false,function(value)
        SpectatePlys = value
    ...
    Combat:AddToggle("传送玩家",false,function(value)
    ...
    Combat:AddToggle("自动杀玩家",false,function(value)
    ...
    Combat:AddToggle("枪自瞄",false,function(value)
        _G.Aimbot_Gun = value
    end)
    ...
    Combat:AddToggle("技能自瞄",false,function(value)
    ...
    Combat:AddToggle("启用pvp",false,function(value)
        _G.EnabledPvP = value
    end)
    ...
    local Current = Combat:AddLabel("目前赏金 :")
    ...
    local Earn = Combat:AddLabel("获得的")
    ...
    Combat:AddToggle("自动赏金",_G.AutoFarmBounty,function(value)
    ...
    Combat:AddToggle("自动赏金 Hop",_G.AutoFarmBounty_Hop,function(value)
    ...
    Combat:AddToggle("开始锁定赏金",false,function(value)
    ...
    Stats:AddSeperator("自动数据点")
    
    local Pointstat = Stats:AddLabel("数据点")
    ...
    Stats:AddToggle("近战",_G.Auto_Melee,function(value)
        _G.Auto_Melee = value
    end)
    
    Stats:AddToggle("血量",_G.Auto_Defense,function(value)
        _G.Auto_Defense = value
    end)
    
    Stats:AddToggle("剑",_G.Auto_Sword,function(value)
        _G.Auto_Sword = value
    end)
    
    Stats:AddToggle("枪",_G.Auto_Gun,function(value)
        _G.Auto_Gun = value
    end)
    
    Stats:AddToggle("恶魔果实",_G.Auto_DevilFruit,function(value)
        _G.Auto_DevilFruit = value
    end)
    
    _G.PointStats = 1
    Stats:AddSlider("选择点数",1,100,1,function(value)
        _G.PointStats = value
    end)
    ...
    Stats:AddSeperator("数据")
    
    local locallv = Stats:AddLabel("等级")
    ...
    local localrace = Stats:AddLabel("种族")
    ...
    local localbeli = Stats:AddLabel("钱")
    ...
    local localexp = Stats:AddLabel("经验")
    ...
    local localstat = Stats:AddLabel("数据点")
    ...
    local localDevil = Stats:AddLabel("恶魔果实")
    ...
    Stats:AddSeperator("虚假功能")
    
    Stats:AddToggle("开启虚假功能",_G.EnabledStat,function(value)
        _G.EnabledStat = value
    end)
    
    Stats:AddTextbox("等级","",true,function(value)
        if _G.EnabledStat then
            game:GetService("Players")["LocalPlayer"].Data.Level.Value = tonumber(value)
        end
    end)
    
    Stats:AddTextbox("经验 ","",true,function(value)
        if _G.EnabledStat then
            game:GetService("Players")["LocalPlayer"].Data.Exp.Value = tonumber(value)
        end
    end)
    
    Stats:AddTextbox("钱","",true,function(value)
        if _G.EnabledStat then
    ...
    Stats:AddTextbox("果子","",true,function(value)
        if _G.EnabledStat then
            game:GetService("Players")["LocalPlayer"].Data.Stats["Demon Fruit"].Level.Value = tonumber(value)
        end
    end)
    
    Stats:AddTextbox("赏金","",true,function(value)
        if _G.EnabledStat then
            game:GetService("Players")["LocalPlayer"].leaderstats["Bounty/Honor"].Value = tonumber(value)
        end
    end)
    
    Teleport:AddSeperator("世界")
    
    Teleport:AddButton("传送一海",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    Teleport:AddButton("传送二海",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    Teleport:AddButton("传送三海",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    Teleport:AddButton("传送海岸",function()
    ...
    local TimeRaid = Dungeon:AddLabel("等待副本")
    ...
    Dungeon:AddToggle("自动副本",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:AddToggle("自动觉醒",_G.Auto_Awakener,function(value)
    ...
    Dungeon:AddDropdown("选择票",{"火焰果","冰果","地震","闪闪","黑暗","线","橡胶","岩浆","佛","沙子","不死鸟"},function(value)
        _G.SelectChip = value
    end)
    
    Dungeon:AddToggle("自动选择的副本",_G.AutoSelectDungeon,function(value)
    ...
    Dungeon:AddToggle("自动买票",_G.AutoBuyChip,function(value)
    ...
    Dungeon:AddButton("买选择的票",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dungeon:AddToggle("自动觉醒",_G.Auto_StartRaid,function(value)
    ...
    Dungeon:AddButton("开始觉醒",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    if World2 then
        Dungeon:AddButton("觉醒房间",function()
    ...
    _G.SelectFruit = ""
    DevilFruit:AddDropdown("选择目标水果",FruitList,function(value)
        _G.SelectFruit = value
    end)
    
    DevilFruit:AddToggle("自动买目标水果",_G.AutoBuyFruitSniper,function(value)
        _G.AutoBuyFruitSniper = value
    end)
    
    DevilFruit:AddSeperator("其他")
    
    DevilFruit:AddDropdown("选择吃水果",FruitList,function(value)
        _G.SelectFruitEat = value
    end)
    
    DevilFruit:AddToggle("自动吃果",_G.AutoEatFruit,function(value)
    ...
    DevilFruit:AddToggle("自动吃果 Hop",_G.AutoEatFruitHop,function(value)
    ...
    DevilFruit:AddToggle("自动抽果",_G.Random_Auto,function(value)
    ...
    DevilFruit:AddButton("抽果",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
    
    DevilFruit:AddToggle("自动扔果",_G.DropFruit,function(value)
        _G.DropFruit = value
    end)
    ...
    DevilFruit:AddToggle("自动存果",_G.AutoStoreFruit,function(value)
    ...
    DevilFruit:AddToggle("带来水果",_G.BringFruit,function(value)
        _G.BringFruit = value
        pcall(function()
    ...
    Shop:AddButton("买Geppo",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    Shop:AddButton("买Buso Haki",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    Shop:AddButton("买Soru",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    Shop:AddButton("买观察",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
    Shop:AddSeperator("拳法")
    
    Shop:AddButton("买黑腿",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
    end)
    
    Shop:AddButton("买雷拳",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
    end)
    
    Shop:AddButton("买鱼人拳",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
    end)
    ...
    Shop:AddButton("买超人拳",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end)
    
    Shop:AddButton("买死腿",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
    end)
    
    Shop:AddButton("买鲨鱼拳",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
    end)
    
    Shop:AddButton("买雷爪",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
    end)
    
    Shop:AddButton("买龙爪v2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
    end)
    -----Shop----------------
    Shop:AddSeperator("附件")
    
    Shop:AddButton("Tomoe环",function()
    ...
    Shop:AddButton("Bisento比森托",function()
    ...
    Shop:AddButton("重置数据点",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,2)
    end)
        
    Shop:AddButton("抽种族",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,3)
    end)
    
    Misc:AddSeperator("服务器")
    
    Misc:AddButton("重进服务器",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Misc:AddButton("换服务器",function()
        Hop()
    end)
    
    Misc:AddButton("换人少的服务器",function()
    ...
    Misc:AddButton("打开水果商店",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    Misc:AddButton("打开仓库",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")
        wait(1)
        game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
    end)
    
    Misc:AddButton("打开水果仓库",function()
    ...
    Misc:AddButton("加入海盗",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Misc:AddButton("加入海军",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
    Misc:AddSeperator("帧率")
    
    Misc:AddButton("解锁入口",function()
    ...
    Misc:AddButton("隐身",function()
        game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    end)
    
    Misc:AddButton("点击传送工具",function()
    ...
    Misc:AddButton("停止所有",function()
        topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
    
    Misc:AddSeperator("兑换码")
    ...
    Misc:AddButton("兑换所有兑换码",function()
    ...
    Misc:AddDropdown("选择兑换码",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:AddButton("兑换",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    Misc:AddSeperator("状态")
    
    Misc:AddDropdown("选择武装色状态",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
        _G.SelectStateHaki = value
    end)
    
    Misc:AddButton("改变武装色状态",function()
    ...
    Misc:AddToggle("光影模式",_G.RTXMode,function(value)
        _G.RTXMode = value
    ...
    Misc:AddToggle("移除雾",RemoveFog,function(value)
        RemoveFog = value
    ...
    Misc:AddButton("解锁帧率",function()
        setfpscap(100)
    end)
    
    Misc:AddSeperator("透视")
    
    Misc:AddToggle("玩家透视",false,function(value)
        ESPPlayer = value
    ...
    Misc:AddToggle("宝箱透视",false,function(value)
        ChestESP = value
    ...
    Misc:AddToggle("水果透视",false,function(value)
        DevilFruitESP = value
    ...
    Misc:AddToggle("花透视",false,function(value)
        FlowerESP = value
    ...
    Misc:AddToggle("岛屿透视",IslandESP,function(value)
        IslandESP = value
    ...
    Misc:AddToggle("躲避没冷却",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Misc:AddToggle("无限愤怒",false,function(value)
        InfiniteEnergy = value
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    Misc:AddToggle("自动开种族技能",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("无限种族技能",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:AddToggle("无限观察范围",getgenv().InfiniteObRange,function(value)
    ...
    Misc:AddToggle("无限Geppo",getgenv().InfGeppo,function(value)
    ...
    Misc:AddToggle("无限soru",getgenv().InfSoru,function(value)
    ...
    Misc:AddToggle("水上行者",_G.WalkWater,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:AddToggle("无碰撞",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    
    Misc:AddSeperator("精通技能设置")
    
    Misc:AddToggle("z技能",true,function(value)
        _G.SkillZ = value
    end)
    
    Misc:AddToggle("x技能",true,function(value)
        _G.SkillX = value
    end)
    
    Misc:AddToggle("c技能",true,function(value)
        _G.SkillC = value
    end)
    
    Misc:AddToggle("v技能",true,function(value)
        _G.SkillV = value
    end)
